...
<div class="iq-tab-content">
    <div class="d-flex flex-wrap align-items-top justify-content-between">
        <ul class="d-flex nav text-center mb-3">
            <li><a href="/addnote"><button type="button" class="btn btn-outline-primary ml-2">New Note</button></a></li>
            <li><a href="/addtodo"><button type="button" class="btn btn-outline-primary ml-2">New To Do</button></a></li>
        </ul>   
    </div>
                                            ...
                                            <div class="card-header d-flex justify-content-between pb-1">
                                                ...
                                                <div class="card-header-toolbar d-flex align-items-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <form action="/deletenote/'.$d[1].'" id="deletenote'.$d[1].'" method="post">';?> @csrf
                                                        <?php echo '</form><i class="fa-solid fa-trash-can" onclick="deletesubmit(\'deletenote'.$d[1].'\')"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                <div class="card-body rounded">
                                                    <h4 class="card-title">'.$d[2].'</h4>
                                                    <p class="mb-3 card-description short">'.$d[3].'</p>                                                            
                                                </div>
                                                <div class="card-footer">
                                                    <div class="d-flex align-items-center justify-content-end note-text note-text-info">
                                                        <a href="#" class=""><i class="fa-solid fa-lg fa-calendar-day mr-2"></i>'.$d[4].'</a>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>';
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="card card-block card-stretch card-height card-bottom-border-danger note-detail">
                                                        <div class="card-header d-flex justify-content-between pb-1">
                                                            <div class="icon iq-icon-box-2 icon-border-danger rounded">' ?>
                                                                @if ($d[4] == 1)
                                                                    <img src="{{URL::asset('images/icons/alert.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @elseif ($d[4] == 2)
                                                                    <img src="{{URL::asset('images/icons/danger.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @elseif ($d[4] == 3)
                                                                    <img src="{{URL::asset('images/icons/fire.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @elseif ($d[4] == 4)
                                                                    <img src="{{URL::asset('images/icons/flower.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @elseif ($d[4] == 5)
                                                                    <img src="{{URL::asset('images/icons/flower2.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @elseif ($d[4] == 6)
                                                                    <img src="{{URL::asset('images/icons/key.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @else
                                                                    <img src="{{URL::asset('images/icons/pen.svg')}}" height="70%" width="70%" style="margin-bottom: 5px;" />
                                                                @endif
                                                                <?php echo '
                                                            </div>
                                                            ...
                                                            <div class="card-header-toolbar d-flex align-items-center">                                                                
                                                                <div class="card-header-toolbar d-flex align-items-center">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <form action="/deletetodo/'.$d[1].'" id="deletetodo'.$d[1].'" method="post">';?> @csrf
                                                                        <?php echo '</form><i class="fa-solid fa-trash-can" onclick="deletesubmit(\'deletetodo'.$d[1].'\')"></i>
                                                                        </span>
                                                    ...
                                                    <div class="card-body rounded">
                                                        ...
                                                        foreach ($d[5] as $c) {
                                                            echo '<form action="/checked/'.$c[1].'" method="post" id="formchecked'.$c[1].'">';?> @csrf<?php echo '</form>
                                                            <form action="/unchecked/'.$c[1].'" method="post" id="formunchecked'.$c[1].'">';?> @csrf<?php echo '</form>
                                                            <div class="checkbox mb-2">';
                                                                $ischecked = ($c[3]==1)? "text-decoration: line-through;" : "";
                                                                $checkit = ($c[3]==1)? "checked" : "";
                                                        
                                                                echo '
                                                                <input type="checkbox" class="checkbox-input mr-3" id="checkbox'.$c[1].'" onclick="check('.$c[1].')" '.$checkit.' "/>
                                                                <label for="checkbox'.$c[1].'" id="chklabel'.$c[1].'" class="note-checkbox mb-0" style="'.$ischecked.'" ">'.$c[2].'</label>
                                                                </div>
                                                                ';
                                                                }
                                                                ...
                                                                <div class="card-footer">
                                                                    <div class="d-flex align-items-center justify-content-end note-text note-text-danger">
                                                                        <a href="#" class=""><i class="fa-solid fa-lg fa-calendar-day mr-2"></i>'.$d[3].'</a>
                                                                    </div>
                                                                </div>
